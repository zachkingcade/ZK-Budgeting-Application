...
class AccountTest {
    ...
    void createNew_typeIdNull_throwsDomainException() {
        assertThrows(DomainException.class, () -> Account.createNew(null, "desc", "notes"));
    }

    @Test
    void createNew_descriptionEmpty_throwsDomainException() {
        assertThrows(DomainException.class, () -> Account.createNew(1L, "", "notes"));
    }

    @Test
    void createNew_notesNull_defaultsToEmptyString() {
        Account account = Account.createNew(1L, "desc", null);
