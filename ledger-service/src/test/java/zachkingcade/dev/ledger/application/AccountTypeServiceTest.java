...
class AccountTypeServiceTest {
    ...
    void updateAccountType_uniqueDescriptionConflict_throwsApplicationException() {
        ...
        accountTypeRepo.whenFindById(AccountType.rehydrate(1L, "Old type", 10L, "notes", true));
        accountTypeRepo.whenExistsByDescription(true);
        accountTypeRepo.whenFindByDescription(AccountType.rehydrate(999L, "New type", 10L, "other", true));
