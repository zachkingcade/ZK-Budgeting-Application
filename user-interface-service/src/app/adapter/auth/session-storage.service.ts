...
export class SessionStorageService {
  ...
  private static readonly ROLES_KEY: string = 'auth.roles';
  ...
  getCachedSession(): ICachedSession | null {
    ...
    const rolesRaw: string | null = localStorage.getItem(SessionStorageService.ROLES_KEY);
  ...
  setCachedSession(session: ICachedSession): void {
    ...
    localStorage.setItem(SessionStorageService.ROLES_KEY, JSON.stringify(session.roles ?? []));
  ...
  clearCachedSession(): void {
    ...
    localStorage.removeItem(SessionStorageService.SESSION_EXPIRES_AT_KEY);
    localStorage.removeItem(SessionStorageService.ROLES_KEY);
  }
}
